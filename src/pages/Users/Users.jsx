            ...
            <article className="users__box">
                <section className="users__box-header">
                    ...
                    <section className="users__active">
                        <p className="users__active-title">CURRENT</p>
                    ...
                    <section className="users__active-head"> {/* Heading to be displayed for only mobile and desktop */}
                        <p className="users__head">AMOUNT</p>    
                        <p className="users__head">DATE BORROWED</p>    
                        <p className="users__head">DATE PAID</p>    
                        <p className="users__head">STATUS</p>    
                    </section> 
                </section>
                ...
                <section className="users__history">
                    ...
                    <section className="users__history-head"> {/* Heading to be displayed for only mobile and desktop */}
                        <p className="users__head-history">NUM</p>
                        <p className="users__head-history">AMOUNT</p>    
                        <p className="users__head-history">DATE BORROWED</p>    
                        <p className="users__head-history">DATE PAID</p>    
                        <p className="users__head-history">STATUS</p>
                    </section> 
                </section>
            </article>
